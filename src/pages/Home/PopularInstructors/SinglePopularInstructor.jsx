...
import ModalContext, { modalContext } from '../../../provider/ModalContext'
    ...
    return (
        ...
        <div className='instructor-items bg-slate-800 border-b-2 border-yellow-400 text-center rounded-xl text-white space-y-2' >
            <div className='relative overflow-hidden'>
                ...
                <div className='absolute bg-slate-800 overlay w-full h-[50%] left-0 -bottom-96 backdrop-blur-xl'>
            ...
            <div className='w-full flex justify-center items-center'>
                <button onClick={()=>setModal(true)} className='bg-sky-500 my-3 px-2 rounded text-white hover:bg-sky-600 uppercase'>See Details</button>
            </div>
            <InstructorModal instructor={instructor} handleClose={handleClose} visible={modal}></InstructorModal>
        </div>
        </Zoom>
    )
}
